...
import { privacyPt, privacyEn } from '../components/legalTexts';
import { colors } from '../components/theme';

// URL da versao web do documento (public/privacy.html servido pelo site).
const FULL_DOC_URL = 'https://naturelensapp.cloud/privacy.html';
  ...
  return (
    <SafeAreaView style={styles.container} edges={['top']}>
      ...
      <View style={styles.topBar}>
        ...
        <Text style={styles.topTitle} accessibilityRole="header">{t('privacy.title')}</Text>
      ...
      >
        ...
        <Section title={t('privacy.noAccountsTitle')}>
          {t('privacy.noAccountsBody')}
        </Section>

        <Section title={t('privacy.dataLossTitle')}>
          {t('privacy.dataLossBody')}
        </Section>
        ...
        <LegalDocument langLabel="Português" sections={privacyPt} />
        <LegalDocument langLabel="English" sections={privacyEn} />

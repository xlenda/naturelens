...
export const privacyPt = [
  ...
  },
  {
    ...
    blocks: [
      ...
      { type: 'li', text: `A melhor proteção é estrutural: não mantemos cópias das fotos nem retemos o áudio bruto depois da inferência em servidores sob nosso controle, não guardamos localização e não exigimos conta para o uso comum.` },
    ],
  },
  {
...
export const privacyEn = [
  ...
  },
  {
    ...
    blocks: [
      ...
      { type: 'li', text: `The best protection is structural: we keep no copies of photos and retain no raw audio after inference on servers we control, store no location and require no account for ordinary use.` },
    ],
  },
  {
